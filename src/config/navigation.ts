  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        titleAr: "نقل بين المخازن",
        href: "/app/stock-transfers",
        icon: ArrowLeftRight,
        permission: "stock-transfers.view",
        keywords: "stock transfers move inventory between warehouses",
      },
      {
        title: "Serial Numbers",
        titleAr: "الأرقام التسلسلية",
        href: "/app/serial-numbers",
        icon: Hash,
        permission: "serial-numbers.view",
        keywords: "serial numbers tracking product units",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "warranties product coverage claims tracking",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        titleAr: "أرباح المنتجات",
        href: "/app/profit-report",
        icon: TrendingUp,
        permission: "reports.view",
        keywords: "profit report product revenue cost margin analysis",
      },
      {
        title: "General Ledger",
        titleAr: "دفتر الأستاذ العام",
        href: "/app/general-ledger",
        icon: BookOpen,
        permission: "reports.view",
        keywords: "general ledger account journal debit credit balance",
      },
      {
        title: "Purchase Reports",
        titleAr: "تقارير المشتريات",
        href: "/app/purchase-reports",
        icon: ShoppingCart,
        permission: "reports.view",
        keywords: "purchase reports supplier category trend analysis",
      },
      {
        title: "Currency Gain/Loss",
        titleAr: "فروقات العملة",
        href: "/app/currency-gain-loss",
        icon: ArrowUpDown,
        permission: "reports.view",
        keywords: "currency gain loss exchange rate difference",
      },
      {
        title: "Period Comparison",
        titleAr: "مقارنة الفترات",
        href: "/app/period-comparison",
        icon: GitCompareArrows,
        permission: "reports.view",
        keywords: "period comparison revenue profit expenses change",
      },
      {
        title: "Branch Profit",
        titleAr: "أرباح الفروع",
        href: "/app/branch-profit",
        icon: Building2,
        permission: "reports.view",
        keywords: "branch profit revenue expenses margin",
      },
      {
        ...
        icon: FileCog,
        permission: "reports.view",
        keywords: "custom reports create edit data source columns",
      },
      {
        title: "Scheduled Reports",
        titleAr: "التقارير المجدولة",
        href: "/app/scheduled-reports",
        icon: CalendarClock,
        permission: "reports.view",
        keywords: "scheduled reports automation frequency",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "payment gateways stripe paypal online payments configuration",
      },
      {
        title: "Devices",
        titleAr: "الأجهزة",
